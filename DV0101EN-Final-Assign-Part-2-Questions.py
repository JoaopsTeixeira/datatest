...
def update_output_container(selected_statistics, input_year):
    if selected_statistics == 'Recession Period Statistics':
        ...
        R_chart2 = dcc.Graph(
            figure=px.bar(average_sales,x='Vehicle_Type',y='Automobile_Sales',title="Average Automobile Sales of Vehicle Types during Recession"))
        ...
        R_chart3 = dcc.Graph(
            figure=px.pie(exp_rec,values='Advertising_Expenditure',names=exp_rec.index,title='Share of Each Vehicle Type in Total Expenditure during Recession'))
